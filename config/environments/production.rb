Myapp::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'www.fantasyoddsmaker.com' }
  # ActionMailer Config
  ...
  config.action_mailer.smtp_settings = {
      ...
      :user_name => "AKIAJ37PHPFHOBGEGPWA", # Your SMTP user here.
      :password => "Aqw/kYI4GM1+Z2EAKuWbNouDU9IOymgSWIeNGKrelCb3", # Your SMTP password here.
